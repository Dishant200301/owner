...
export const G2Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const CapterraIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="100%" height="100%" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
// Note: The original had a separate SVG for the arrow tail,
// but for simplicity and common usage, it's often combined
// with the head into one arrow icon, as done above.
// If the distinct tail is crucial for animation, it would be another SVG component.